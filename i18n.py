...
TRANSLATIONS = {
    "zh": {
        ...
        "tab_models": "模型设置",
        "tab_tools": "实用工具",
        "tab_actions_title": "操作",
        "realtime_output_title": "实时输出信息",
        "models_asr_actions": "听写模型",
        "models_translation_actions": "翻译模型",
        "tools_file_actions": "文件选择",
        "tools_run_actions": "运行工具",
        "dict_save_btn": "保存字典设置",
        "dict_open_dir_btn": "打开字典目录",
        ...
        # === Input/Output Tab ===
        "io_input_label": "📥 输入文件或链接",
        "io_input_tip": "支持拖拽音视频或SRT文件，也可每行输入一个B站BV号、YouTube或其他视频链接。",
        "io_input_placeholder": "例如：C:/video.mp4或https://www.youtube.com/watch?v=...或BV1Lxt5e8EJF",
        "io_transcription_group_title": "🎙️ 听写设置",
        "io_translation_group_title": "🌐 翻译设置",
        "io_output_group_title": "📤 字幕输出",
        "io_proxy_label": "🌐 网络代理",
        "io_proxy_placeholder": "例如：http://127.0.0.1:7890，留空为不使用",
        "io_output_dir_label": "📤 输出目录",
        "io_output_dir_tip": "下载文件和生成的字幕将保存到此目录。",
        "io_browse_dir_btn": "📂 选择目录",
        "io_use_input_dir_checkbox": "📂 输出到源文件目录",
        "io_use_input_dir_tip": "启用后，每个结果保存到对应源文件所在目录。",
        "io_format_label": "🎞️ 字幕格式",
        "io_format_tip": "选择原文、译文或双语的SRT/LRC输出格式。",
        "io_output_target_label": "🎯 输出目标",
        "io_output_target_tip": "选择输出原文、目标译文或双语字幕。",
        "io_output_type_label": "📄 文件格式",
        "io_output_type_tip": "选择SRT字幕或LRC歌词格式。",
        "output_target_original": "原文",
        "output_target_translated": "目标",
        "output_target_bilingual": "双语",
        "output_type_srt": "SRT",
        "output_type_lrc": "LRC",
        ...
        "io_segment_checkbox": "✂️ 分段处理长音频",
        "io_segment_tip": "先将长音频分段听写和翻译，再自动合并结果。",
        "io_segment_duration_label": "⏱️ 分段时长（分钟）",
        "io_run_btn": "🚀 运行",
        "io_cancel_btn": "⛔ 取消任务",
        "io_open_output_btn": "📁 打开输出目录",
        "io_clean_btn": "🧹 清空下载和缓存",
        "io_auto_shutdown_checkbox": "⏻ 完成后自动关机",
        "io_enable_transcription_checkbox": "🎙️ 听写",
        "io_enable_translation_checkbox": "🌐 翻译",
        "io_transcription_lang_label": "🎤 听写语言",
        "io_target_lang_label": "🌐 翻译目标语言",
        "io_concurrency_label": "🧵 并发数（0=串行）",
        "io_concurrency_tip": "同时处理的翻译任务数。0为串行；本地模型建议使用0，在线模型可根据接口配额调整。",
        ...
        # === Dict Tab ===
        "dict_before_label": "📘 译前字典",
        "dict_before_tip": "在送入翻译模型前替换原文。每行使用Tab分隔原文和替换词。",
        "dict_before_placeholder": "原文(Tab键)替换词\n原文(Tab键)替换词",
        "dict_gpt_label": "📗 译中字典",
        "dict_gpt_tip": "向翻译模型指定词语的目标译文。每行使用Tab分隔。",
        "dict_gpt_placeholder": "原文(Tab键)目标译文\n原文(Tab键)目标译文",
        "dict_after_label": "📙 译后字典",
        "dict_after_tip": "翻译完成后替换译文。每行使用Tab分隔目标文本和替换词。",
        "dict_after_placeholder": "目标原文(Tab键)目标替换词\n目标原文(Tab键)目标替换词",
        "dict_extra_label": "💡 额外提示",
        "dict_extra_tip": "可填写世界观、人物设定或台本背景等上下文。",
        "dict_extra_placeholder": "请在这里输入额外的提示信息，例如世界书或台本内容。",
        "dict_prompt_mode_label": "🧩 提示处理方式",
        "dict_prompt_mode_no": "不修改",
        "dict_prompt_mode_append": "追加",
        "dict_prompt_mode_overwrite": "覆盖",

        # === Settings Tab (Speech) ===
        "settings_asr_model_label": "🗣️ 识别模型",
        "settings_asr_model_tip": "从crispasr目录选择用于语音识别的GGUF模型。",
        "settings_asr_aligner_label": "📐 对齐模型",
        "settings_asr_aligner_tip": "选择用于生成精确字幕时间轴的强制对齐模型。",
        "settings_asr_backend_label": "⚙️ 识别后端",
        "settings_asr_backend_tip": "后端必须与所选识别模型兼容。",
        "settings_lang_label": "🌍 输入语言",
        "settings_lang_tip": "语言代码：ja日语、en英语、ko韩语、ru俄语、fr法语、zh中文。",
        "settings_asr_param_label": "🛠️ CrispASR 参数",
        ...
        "settings_test_offline_asr_btn": "🧪 测试听写模型",
        "settings_uvr_label": "🎤 人声分离模型",
        "settings_uvr_tip": "从separate目录选择用于分离人声与伴奏的ONNX模型。",
        "settings_open_uvr_btn": "📁 打开UVR模型目录",
        "settings_refresh_uvr_btn": "🔄 刷新人声分离模型列表",

        # === Advanced Settings Tab (Language Model) ===
        "adv_translator_label": "🤖 翻译模型",
        "adv_translator_tip": "选择在线、自定义或本地翻译模型。",
        "adv_translator_mode_label": "🌐 模型类型",
        "adv_translator_mode_online": "在线",
        "adv_translator_mode_local": "本地",
        "adv_online_translator_label": "☁️ 在线翻译器",
        "adv_local_translator_label": "💻 本地翻译器",
        "adv_online_token_label": "🔑 API 令牌",
        "adv_online_token_placeholder": "留空为使用上次配置的Token。",
        "adv_online_model_label": "☁️ 在线模型",
        "adv_online_model_placeholder": "例如：deepseek-chat",
        "adv_online_address_label": "🔗 API 地址",
        "adv_online_address_tip": "自定义模型填写API基础地址，不包含/v1/chat/completions。",
        "adv_online_address_placeholder": "例如：http://127.0.0.1:11434",
        "adv_offline_model_label": "💾 离线模型",
        "adv_offline_gpu_label": "🎮 GPU 加载层数",
        "adv_offline_param_label": "🛠️ 离线模型参数",
        "adv_offline_param_placeholder": "每个参数空格隔开，请参考Llama.cpp文档，不清楚请保持默认。",
        "adv_open_model_btn": "📁 打开离线模型目录",
        "adv_refresh_model_btn": "🔄 刷新离线模型列表",
        "adv_test_offline_btn": "🧪 测试离线翻译模型",
        "adv_test_api_btn": "🔍 测试模型API并列出可用模型",
        "status_offline_test_busy": "[WARNING] 当前有任务正在运行，请等待完成或先取消。",
        "status_offline_test_cancelled": "[INFO] 离线模型测试已取消。",
        "offline_test_audio_missing": "应用内置的测试音频不存在，请重新安装完整应用包",
        "offline_test_asr_model_missing": "请选择听写模型",
        "offline_test_aligner_missing": "请选择对齐模型",
        "offline_test_translation_model_missing": "请选择离线翻译模型",
        "offline_test_asr_timeout": "听写模型测试超过 5 分钟",
        "offline_test_asr_no_output": "听写模型未生成有效 SRT，请确认测试音频包含清晰语音",
        "offline_test_no_response": "模型服务没有返回有效响应",
        "offline_test_translation_timeout": "离线翻译模型在 3 分钟内未就绪：{detail}",
        "status_offline_asr_test_starting": "[INFO] 正在加载听写模型 {model} 并执行测试音频...",
        "status_offline_asr_test_success": "[INFO] ✅ 离线听写模型测试通过，耗时 {seconds:.1f} 秒。",
        "status_offline_asr_test_failed": "[ERROR] ❌ 离线听写模型测试失败：{error}",
        "status_offline_translation_test_starting": "[INFO] 正在加载离线翻译模型 {model} 并执行一次推理...",
        "status_offline_translation_test_success": "[INFO] ✅ 离线翻译模型测试通过，耗时 {seconds:.1f} 秒。",
        "status_offline_translation_test_failed": "[ERROR] ❌ 离线翻译模型测试失败：{error}",

        # === Clip Tab ===
        "clip_tool_label": "🔪 切片工具",
        "clip_placeholder": "拖拽视频文件到方框内，并填写开始和结束时间，点击运行即可。",
        "clip_start_label": "⏱️ 开始时间",
        "clip_end_label": "🏁 结束时间",
        ...
        "dialog_select_model_label": "🤖 选择模型",
        "dialog_ok": "确定",
        "dialog_cancel": "取消",
    ...
    "en": {
        ...
        "tab_models": "Model Settings",
        "tab_tools": "Utilities",
        "tab_actions_title": "Actions",
        "realtime_output_title": "Realtime Output",
        "models_asr_actions": "Transcription Model",
        "models_translation_actions": "Translation Model",
        "tools_file_actions": "File Selection",
        "tools_run_actions": "Run Tools",
        "dict_save_btn": "Save Dictionary Settings",
        "dict_open_dir_btn": "Open Dictionary Folder",
        ...
        "about_text": (
            ...
            "- Separation: Select a separation model, split vocals and accompaniment, or clip audio files.\n"
            ...
            "- Speech Model: Select a CrispASR model and configure the transcription language and optional arguments.\n"
        ...
        "about_wiki_btn": "📖 View Repository",
        ...
        # === Input/Output Tab ===
        "io_input_label": "📥 Files or Links",
        "io_input_tip": "Drop audio, video, or SRT files, or enter one Bilibili BV ID, YouTube URL, or other video link per line.",
        "io_input_placeholder": "Example: C:/video.mp4 or https://www.youtube.com/watch?v=... or BV1Lxt5e8EJF",
        "io_transcription_group_title": "🎙️ Transcription",
        "io_translation_group_title": "🌐 Translation",
        "io_output_group_title": "📤 Subtitle Output",
        "io_proxy_label": "🌐 Network Proxy",
        "io_proxy_placeholder": "Example: http://127.0.0.1:7890, leave empty to disable",
        "io_output_dir_label": "📤 Output Directory",
        "io_output_dir_tip": "Downloaded files and generated subtitles are saved here.",
        "io_browse_dir_btn": "📂 Browse Directory",
        "io_use_input_dir_checkbox": "📂 Use Source Directory",
        "io_use_input_dir_tip": "Save each result beside its corresponding source file.",
        "io_format_label": "🎞️ Subtitle Format",
        "io_format_tip": "Choose original, translated, or bilingual SRT/LRC output.",
        "io_output_target_label": "🎯 Output Target",
        "io_output_target_tip": "Output source text, translated text, or bilingual subtitles.",
        "io_output_type_label": "📄 File Format",
        "io_output_type_tip": "Choose SRT subtitles or LRC lyrics.",
        "output_target_original": "Original",
        "output_target_translated": "Translated",
        "output_target_bilingual": "Bilingual",
        "output_type_srt": "SRT",
        "output_type_lrc": "LRC",
        ...
        "io_segment_checkbox": "✂️ Split Long Audio",
        "io_segment_tip": "Transcribe and translate long audio in segments, then merge the results automatically.",
        "io_segment_duration_label": "⏱️ Segment Length (min)",
        "io_run_btn": "🚀 Run",
        "io_cancel_btn": "⛔ Cancel Task",
        "io_open_output_btn": "📁 Open Output Directory",
        "io_clean_btn": "🧹 Clear Downloads & Cache",
        "io_auto_shutdown_checkbox": "⏻ Shut Down When Done",
        "io_enable_transcription_checkbox": "🎙️ Transcribe",
        ...
        "io_concurrency_label": "🧵 Concurrency (0=serial)",
        "io_concurrency_tip": "Number of translation tasks processed at once. Use 0 for serial processing; 0 is recommended for local models, while online models can follow the API quota.",
        "target_lang_zh_cn": "简体中文(zh-cn)",
        "target_lang_zh_tw": "繁體中文(zh-tw)",
        "target_lang_en": "English(en)",
        "target_lang_ja": "日本語(ja)",
        ...
        # === Dict Tab ===
        "dict_before_label": "📘 Pre-translation Dictionary",
        "dict_before_tip": "Replace source text before it is sent to the translation model. Separate each pair with a Tab.",
        "dict_before_placeholder": "Source(Tab)Replacement\nSource(Tab)Replacement",
        "dict_gpt_label": "📗 Translation Dictionary",
        "dict_gpt_tip": "Specify preferred translations for the model. Separate each pair with a Tab.",
        "dict_gpt_placeholder": "Source(Tab)Target\nSource(Tab)Target",
        "dict_after_label": "📙 Post-translation Dictionary",
        "dict_after_tip": "Replace translated text after translation. Separate each pair with a Tab.",
        "dict_after_placeholder": "Target source(Tab)Target replacement\nTarget source(Tab)Target replacement",
        "dict_extra_label": "💡 Extra Prompt",
        "dict_extra_tip": "Add world-building, character, or script context for the translation model.",
        "dict_extra_placeholder": "Enter additional prompt info here, such as world book or script content.",
        "dict_prompt_mode_label": "🧩 Prompt Handling",
        "dict_prompt_mode_no": "Do not modify",
        "dict_prompt_mode_append": "Append",
        "dict_prompt_mode_overwrite": "Overwrite",

        # === Settings Tab (Speech) ===
        "settings_asr_model_label": "🗣️ Recognition Model",
        "settings_asr_model_tip": "Select a GGUF speech-recognition model from the crispasr directory.",
        "settings_asr_aligner_label": "📐 Alignment Model",
        "settings_asr_aligner_tip": "Select the forced-alignment model used to generate accurate subtitle timing.",
        "settings_asr_backend_label": "⚙️ Recognition Backend",
        "settings_asr_backend_tip": "The backend must be compatible with the selected recognition model.",
        "settings_lang_label": "🌍 Input Language",
        "settings_lang_tip": "Language codes: ja Japanese, en English, ko Korean, ru Russian, fr French, zh Chinese.",
        "settings_asr_param_label": "🛠️ CrispASR Parameters",
        ...
        "settings_test_offline_asr_btn": "🧪 Test Offline Transcription",
        "settings_uvr_label": "🎤 Vocal Separation Model",
        "settings_uvr_tip": "Select an ONNX model from the separate directory to split vocals and accompaniment.",
        "settings_open_uvr_btn": "📁 Open UVR Model Directory",
        "settings_refresh_uvr_btn": "🔄 Refresh Vocal Separation Models",

        # === Advanced Settings Tab (Language Model) ===
        "adv_translator_label": "🤖 Translation Model",
        "adv_translator_tip": "Choose an online, custom, or local translation model.",
        "adv_translator_mode_label": "🌐 Model Type",
        "adv_translator_mode_online": "Online",
        "adv_translator_mode_local": "Local",
        "adv_online_translator_label": "☁️ Online Translator",
        "adv_local_translator_label": "💻 Local Translator",
        "adv_online_token_label": "🔑 API Token",
        "adv_online_token_placeholder": "Leave empty to use last configured token.",
        "adv_online_model_label": "☁️ Online Model",
        "adv_online_model_placeholder": "Example: deepseek-chat",
        "adv_online_address_label": "🔗 API Address",
        "adv_online_address_tip": "For custom models, enter the API base address without /v1/chat/completions.",
        "adv_online_address_placeholder": "Example: http://127.0.0.1:11434",
        "adv_offline_model_label": "💾 Offline Model",
        "adv_offline_gpu_label": "🎮 GPU Layers",
        "adv_offline_param_label": "🛠️ Offline Model Parameters",
        ...
        "adv_test_offline_btn": "🧪 Test Offline Translation",
        "adv_test_api_btn": "🔍 Test Model API & List Available Models",
        "status_offline_test_busy": "[WARNING] Another task is running. Wait for it to finish or cancel it first.",
        "status_offline_test_cancelled": "[INFO] Offline model test cancelled.",
        "offline_test_audio_missing": "The bundled test audio is missing; reinstall the complete application package",
        "offline_test_asr_model_missing": "Select a transcription model",
        "offline_test_aligner_missing": "Select an alignment model",
        "offline_test_translation_model_missing": "Select an offline translation model",
        "offline_test_asr_timeout": "The transcription model test exceeded 5 minutes",
        "offline_test_asr_no_output": "The transcription model did not create a valid SRT; use a sample with clear speech",
        "offline_test_no_response": "The model server returned no valid response",
        "offline_test_translation_timeout": "The offline translation model was not ready within 3 minutes: {detail}",
        "status_offline_asr_test_starting": "[INFO] Loading transcription model {model} and processing the test audio...",
        "status_offline_asr_test_success": "[INFO] ✅ Offline transcription test passed in {seconds:.1f} seconds.",
        "status_offline_asr_test_failed": "[ERROR] ❌ Offline transcription test failed: {error}",
        "status_offline_translation_test_starting": "[INFO] Loading offline translation model {model} and running one inference...",
        "status_offline_translation_test_success": "[INFO] ✅ Offline translation test passed in {seconds:.1f} seconds.",
        "status_offline_translation_test_failed": "[ERROR] ❌ Offline translation test failed: {error}",

        # === Clip Tab ===
        "clip_tool_label": "🔪 Clip Tool",
        "clip_placeholder": "Drag video files into the box, fill in start and end times, then click Run.",
        "clip_start_label": "⏱️ Start Time",
        ...
        "synth_font_label": "🔤 Subtitle Font",
        ...
        "dialog_select_model_label": "🤖 Select Model",
        "dialog_ok": "OK",
    ...
    "ja": {
        ...
        "tab_tools": "ユーティリティ",
        "tab_actions_title": "操作",
        "realtime_output_title": "リアルタイム出力",
        "models_asr_actions": "文字起こしモデル",
        "models_translation_actions": "翻訳モデル",
        "tools_file_actions": "ファイル選択",
        "tools_run_actions": "ツール実行",
        "dict_save_btn": "辞書設定を保存",
        "dict_open_dir_btn": "辞書フォルダーを開く",
        ...
        # === Input/Output Tab ===
        "io_input_label": "📥 ファイルまたはリンク",
        "io_input_tip": "音声・動画・SRTをドロップするか、BilibiliのBV番号、YouTubeなどの動画リンクを1行ずつ入力します。",
        "io_input_placeholder": "例：C:/video.mp4 または https://www.youtube.com/watch?v=... または BV1Lxt5e8EJF",
        "io_transcription_group_title": "🎙️ 文字起こし設定",
        "io_translation_group_title": "🌐 翻訳設定",
        "io_output_group_title": "📤 字幕出力",
        "io_proxy_label": "🌐 ネットワークプロキシ",
        "io_proxy_placeholder": "例：http://127.0.0.1:7890、空欄で無効",
        "io_output_dir_label": "📤 出力先",
        "io_output_dir_tip": "ダウンロードしたファイルと生成した字幕をこのフォルダーに保存します。",
        "io_browse_dir_btn": "📂 ディレクトリを参照",
        "io_use_input_dir_checkbox": "📂 元ファイルのフォルダーに出力",
        "io_use_input_dir_tip": "各処理結果を対応する元ファイルと同じフォルダーに保存します。",
        "io_format_label": "🎞️ 字幕形式",
        "io_format_tip": "原文、翻訳文、または二言語のSRT/LRC形式を選択します。",
        "io_output_target_label": "🎯 出力対象",
        "io_output_target_tip": "原文、翻訳文、または二言語字幕を選択します。",
        "io_output_type_label": "📄 ファイル形式",
        "io_output_type_tip": "SRT字幕またはLRC歌詞形式を選択します。",
        "output_target_original": "原文",
        "output_target_translated": "翻訳文",
        "output_target_bilingual": "二言語",
        "output_type_srt": "SRT",
        "output_type_lrc": "LRC",
        "format_original_srt": "原文SRT",
        "format_original_lrc": "原文LRC",
        ...
        "io_segment_checkbox": "✂️ 長い音声を分割",
        "io_segment_tip": "長い音声を分割して文字起こし・翻訳し、結果を自動的に結合します。",
        "io_segment_duration_label": "⏱️ 分割時間（分）",
        "io_run_btn": "🚀 実行",
        "io_cancel_btn": "⛔ タスクキャンセル",
        "io_open_output_btn": "📁 出力ディレクトリを開く",
        "io_clean_btn": "🧹 ダウンロードとキャッシュを削除",
        "io_auto_shutdown_checkbox": "⏻ 完了後にシャットダウン",
        "io_enable_transcription_checkbox": "🎙️ 文字起こし",
        "io_enable_translation_checkbox": "🌐 翻訳",
        "io_transcription_lang_label": "🎤 文字起こし言語",
        "io_target_lang_label": "🌐 翻訳対象言語",
        "io_concurrency_label": "🧵 同時実行数（0=直列）",
        "io_concurrency_tip": "同時に処理する翻訳タスク数です。0は直列処理。ローカルモデルは0を推奨し、オンラインモデルはAPIの上限に合わせて調整してください。",
        "target_lang_zh_cn": "简体中文(zh-cn)",
        "target_lang_zh_tw": "繁體中文(zh-tw)",
        "target_lang_en": "English(en)",
        "target_lang_ja": "日本語(ja)",
        ...
        # === Dict Tab ===
        "dict_before_label": "📘 翻訳前辞書",
        "dict_before_tip": "翻訳モデルへ送る前に原文を置換します。各ペアはTabで区切ります。",
        "dict_before_placeholder": "原文(Tab)置換語\n原文(Tab)置換語",
        "dict_gpt_label": "📗 翻訳中辞書",
        "dict_gpt_tip": "翻訳モデルに優先訳を指定します。各ペアはTabで区切ります。",
        "dict_gpt_placeholder": "原文(Tab)ターゲット訳文\n原文(Tab)ターゲット訳文",
        "dict_after_label": "📙 翻訳後辞書",
        "dict_after_tip": "翻訳後のテキストを置換します。各ペアはTabで区切ります。",
        "dict_after_placeholder": "ターゲット原文(Tab)ターゲット置換語\nターゲット原文(Tab)ターゲット置換語",
        "dict_extra_label": "💡 追加プロンプト",
        "dict_extra_tip": "世界観、人物設定、台本の背景などの文脈を追加します。",
        "dict_extra_placeholder": "追加のプロンプト情報をここに入力してください（世界観設定や台本内容など）。",
        "dict_prompt_mode_label": "🧩 プロンプト処理",
        "dict_prompt_mode_no": "変更しない",
        "dict_prompt_mode_append": "追記",
        "dict_prompt_mode_overwrite": "上書き",

        # === Settings Tab (Speech) ===
        "settings_asr_model_label": "🗣️ 認識モデル",
        "settings_asr_model_tip": "crispasrフォルダーから音声認識用GGUFモデルを選択します。",
        "settings_asr_aligner_label": "📐 アライメントモデル",
        "settings_asr_aligner_tip": "正確な字幕タイミングを生成する強制アライメントモデルを選択します。",
        "settings_asr_backend_label": "⚙️ 認識バックエンド",
        "settings_asr_backend_tip": "選択した認識モデルに対応するバックエンドを選びます。",
        "settings_lang_label": "🌍 入力言語",
        "settings_lang_tip": "言語コード：ja日本語、en英語、ko韓国語、ruロシア語、frフランス語、zh中国語。",
        "settings_asr_param_label": "🛠️ CrispASR パラメータ",
        ...
        "settings_test_offline_asr_btn": "🧪 オフライン文字起こしをテスト",
        "settings_uvr_label": "🎤 ボーカル分離モデル",
        "settings_uvr_tip": "separateフォルダーからボーカルと伴奏を分離するONNXモデルを選択します。",
        "settings_open_uvr_btn": "📁 UVRモデルディレクトリを開く",
        "settings_refresh_uvr_btn": "🔄 ボーカル分離モデルを更新",

        # === Advanced Settings Tab (Language Model) ===
        "adv_translator_label": "🤖 翻訳モデル",
        "adv_translator_tip": "オンライン、カスタム、またはローカル翻訳モデルを選択します。",
        "adv_translator_mode_label": "🌐 モデルタイプ",
        "adv_translator_mode_online": "オンライン",
        "adv_translator_mode_local": "ローカル",
        "adv_online_translator_label": "☁️ オンライン翻訳",
        "adv_local_translator_label": "💻 ローカル翻訳",
        "adv_online_token_label": "🔑 API トークン",
        "adv_online_token_placeholder": "空欄で前回設定したトークンを使用。",
        "adv_online_model_label": "☁️ オンラインモデル",
        "adv_online_model_placeholder": "例：deepseek-chat",
        "adv_online_address_label": "🔗 API アドレス",
        "adv_online_address_tip": "カスタムモデルでは/v1/chat/completionsを除いたAPIベースアドレスを入力します。",
        "adv_online_address_placeholder": "例：http://127.0.0.1:11434",
        "adv_offline_model_label": "💾 オフラインモデル",
        "adv_offline_gpu_label": "🎮 GPUレイヤー数",
        "adv_offline_param_label": "🛠️ オフラインモデル引数",
        ...
        "adv_test_offline_btn": "🧪 オフライン翻訳をテスト",
        "adv_test_api_btn": "🔍 モデルAPIをテストして利用可能なモデルを一覧表示",
        "status_offline_test_busy": "[WARNING] 別のタスクが実行中です。完了を待つか、先にキャンセルしてください。",
        "status_offline_test_cancelled": "[INFO] オフラインモデルのテストをキャンセルしました。",
        "offline_test_audio_missing": "内蔵テスト音声がありません。完全なアプリパッケージを再インストールしてください",
        "offline_test_asr_model_missing": "文字起こしモデルを選択してください",
        "offline_test_aligner_missing": "アライメントモデルを選択してください",
        "offline_test_translation_model_missing": "オフライン翻訳モデルを選択してください",
        "offline_test_asr_timeout": "文字起こしモデルのテストが5分を超えました",
        "offline_test_asr_no_output": "有効なSRTが生成されませんでした。明瞭な音声を含むサンプルを使用してください",
        "offline_test_no_response": "モデルサーバーから有効な応答がありません",
        "offline_test_translation_timeout": "オフライン翻訳モデルが3分以内に準備できませんでした：{detail}",
        "status_offline_asr_test_starting": "[INFO] 文字起こしモデル {model} を読み込み、テスト音声を処理中...",
        "status_offline_asr_test_success": "[INFO] ✅ オフライン文字起こしテストに成功しました（{seconds:.1f}秒）。",
        "status_offline_asr_test_failed": "[ERROR] ❌ オフライン文字起こしテストに失敗：{error}",
        "status_offline_translation_test_starting": "[INFO] オフライン翻訳モデル {model} を読み込み、推論を実行中...",
        "status_offline_translation_test_success": "[INFO] ✅ オフライン翻訳テストに成功しました（{seconds:.1f}秒）。",
        "status_offline_translation_test_failed": "[ERROR] ❌ オフライン翻訳テストに失敗：{error}",

        # === Clip Tab ===
        "clip_tool_label": "🔪 クリップツール",
        "clip_placeholder": "動画ファイルをボックスにドラッグし、開始時間と終了時間を入力して実行をクリック。",
        "clip_start_label": "⏱️ 開始時間",
        "clip_end_label": "🏁 終了時間",
        ...
        "dialog_select_model_label": "🤖 モデル選択",
        "dialog_ok": "OK",
        "dialog_cancel": "キャンセル",

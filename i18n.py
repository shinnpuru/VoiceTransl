...
TRANSLATIONS = {
    "zh": {
        ...
        "adv_concurrency_label": "🧵 并发数",
        "adv_concurrency_tip": "0为串行；1以上为并发任务数。",
    ...
    "en": {
        ...
        "adv_concurrency_label": "🧵 Concurrency",
        "adv_concurrency_tip": "0 runs serially; values above 0 set the concurrent task count.",
    ...
    "ja": {
        ...
        "adv_concurrency_label": "🧵 同時実行数",
        "adv_concurrency_tip": "0は直列実行、1以上は同時タスク数です。",

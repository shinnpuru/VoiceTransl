...
TRANSLATIONS = {
    "zh": {
        ...
        # === ASRLabs Integration ===
        "settings_asr_engine_label": "🗣️ 听写引擎",
        "settings_asr_model_label": "📦 听写模型路径（本地目录或 HuggingFace ID）",
        "settings_asr_device_label": "🖥️ 设备",
        "settings_asr_compute_type_label": "⚙️ 计算精度",
        "settings_asr_extra_label": "🔧 额外参数（空格分隔，透传给 asrlabs transcribe）",
        "settings_asr_extra_placeholder": "如：--beam_size 5，留空使用默认",
        "settings_align_engine_label": "⏱️ 对齐引擎",
        "settings_align_no_align": "不进行对齐（使用内置时间戳）",
        "settings_align_model_label": "📦 对齐模型路径",
        "settings_align_device_label": "🖥️ 对齐设备",
        "settings_align_extra_label": "🔧 对齐额外参数",
        "settings_align_extra_placeholder": "如：--beam_size 3，留空使用默认",
        "settings_open_transcribe_dir_btn": "📁 打开听写模型目录",
        "settings_open_align_dir_btn": "📁 打开对齐模型目录",
        "settings_refresh_asr_btn": "🔄 刷新引擎与模型列表",
        "settings_asr_no_timestamps_hint": "⚠️ 当前引擎无内置时间戳，必须选择对齐器",
        "status_asrlabs_transcribing": "[INFO] [ASRLabs] 正在听写：{engine} -> {audio}",
        "status_asrlabs_aligning": "[INFO] [ASRLabs] 正在对齐：{aligner} -> {audio}",
        "status_asrlabs_done": "[INFO] [ASRLabs] 听写+对齐完成：{output}",
        "status_asrlabs_error": "[ERROR] [ASRLabs] 处理失败: {error}",
        "status_asrlabs_no_engine": "[ERROR] 未选择听写引擎，请在语音模型设置中选择。",
        "status_asrlabs_metadata_error": "[ERROR] 获取 ASRLabs 引擎列表失败: {error}",
    },
    "en": {
        # === Window & Tray ===
        "window_title": "VoiceTransl",
        ...
        # === ASRLabs Integration ===
        "settings_asr_engine_label": "🗣️ Transcription Engine",
        "settings_asr_model_label": "📦 Model Path (local directory or HuggingFace ID)",
        "settings_asr_device_label": "🖥️ Device",
        "settings_asr_compute_type_label": "⚙️ Compute Type",
        "settings_asr_extra_label": "🔧 Extra Parameters (space-separated, passed to asrlabs transcribe)",
        "settings_asr_extra_placeholder": "e.g. --beam_size 5, leave empty for default",
        "settings_align_engine_label": "⏱️ Alignment Engine",
        "settings_align_no_align": "No alignment (use built-in timestamps)",
        "settings_align_model_label": "📦 Alignment Model Path",
        "settings_align_device_label": "🖥️ Alignment Device",
        "settings_align_extra_label": "🔧 Alignment Extra Parameters",
        "settings_align_extra_placeholder": "e.g. --beam_size 3, leave empty for default",
        "settings_open_transcribe_dir_btn": "📁 Open Transcribe Model Directory",
        "settings_open_align_dir_btn": "📁 Open Align Model Directory",
        "settings_refresh_asr_btn": "🔄 Refresh Engine & Model List",
        "settings_asr_no_timestamps_hint": "⚠️ Current engine has no built-in timestamps, an aligner is required",
        "status_asrlabs_transcribing": "[INFO] [ASRLabs] Transcribing: {engine} -> {audio}",
        "status_asrlabs_aligning": "[INFO] [ASRLabs] Aligning: {aligner} -> {audio}",
        "status_asrlabs_done": "[INFO] [ASRLabs] Transcription+alignment complete: {output}",
        "status_asrlabs_error": "[ERROR] [ASRLabs] Processing failed: {error}",
        "status_asrlabs_no_engine": "[ERROR] No transcription engine selected, please configure in Speech Model settings.",
        "status_asrlabs_metadata_error": "[ERROR] Failed to fetch ASRLabs engine list: {error}",
    },
    "ja": {
        # === Window & Tray ===
        "window_title": "VoiceTransl",
        ...
        # === ASRLabs Integration ===
        "settings_asr_engine_label": "🗣️ 文字起こしエンジン",
        "settings_asr_model_label": "📦 モデルパス（ローカルディレクトリまたはHuggingFace ID）",
        "settings_asr_device_label": "🖥️ デバイス",
        "settings_asr_compute_type_label": "⚙️ 計算精度",
        "settings_asr_extra_label": "🔧 追加パラメータ（スペース区切り、asrlabs transcribeに透過）",
        "settings_asr_extra_placeholder": "例: --beam_size 5、空欄でデフォルト",
        "settings_align_engine_label": "⏱️ アライメントエンジン",
        "settings_align_no_align": "アライメントなし（内蔵タイムスタンプを使用）",
        "settings_align_model_label": "📦 アライメントモデルパス",
        "settings_align_device_label": "🖥️ アライメントデバイス",
        "settings_align_extra_label": "🔧 アライメント追加パラメータ",
        "settings_align_extra_placeholder": "例: --beam_size 3、空欄でデフォルト",
        "settings_open_transcribe_dir_btn": "📁 文字起こしモデルディレクトリを開く",
        "settings_open_align_dir_btn": "📁 アライメントモデルディレクトリを開く",
        "settings_refresh_asr_btn": "🔄 エンジンとモデルリストを更新",
        "settings_asr_no_timestamps_hint": "⚠️ 現在のエンジンには内蔵タイムスタンプがありません。アライナーを選択する必要があります。",
        "status_asrlabs_transcribing": "[INFO] [ASRLabs] 文字起こし中: {engine} -> {audio}",
        "status_asrlabs_aligning": "[INFO] [ASRLabs] アライメント中: {aligner} -> {audio}",
        "status_asrlabs_done": "[INFO] [ASRLabs] 文字起こし+アライメント完了: {output}",
        "status_asrlabs_error": "[ERROR] [ASRLabs] 処理失敗: {error}",
        "status_asrlabs_no_engine": "[ERROR] 文字起こしエンジンが選択されていません。音声モデル設定で構成してください。",
        "status_asrlabs_metadata_error": "[ERROR] ASRLabsエンジンリストの取得に失敗: {error}",
    },
}

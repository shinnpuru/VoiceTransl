...
TRANSLATIONS = {
    "zh": {
        ...
        "io_enable_transcription_checkbox": "进行听写",
        "io_enable_translation_checkbox": "进行翻译",
        ...
        "settings_asr_aligner_label": "📐 选择CrispASR强制对齐模型文件。",
        "settings_asr_backend_label": "⚙️ 选择CrispASR识别后端。",
        ...
        "status_no_translator_skip": "[INFO] 未勾选进行翻译，跳过翻译步骤...",
    ...
    "en": {
        ...
        "io_enable_transcription_checkbox": "Transcribe",
        "io_enable_translation_checkbox": "Translate",
        ...
        "settings_asr_aligner_label": "📐 Select a CrispASR forced-alignment model.",
        "settings_asr_backend_label": "⚙️ Select a CrispASR recognition backend.",
        ...
        "settings_asr_param_placeholder": "Placeholders: $crispasr_executable, $backend, $model_file, $aligner_file, $language, $output_file, and $input_file.",
        ...
        "status_no_translator_skip": "[INFO] Translation is not selected, skipping translation...",
    ...
    "ja": {
        ...
        "io_enable_transcription_checkbox": "文字起こしを行う",
        "io_enable_translation_checkbox": "翻訳を行う",
        ...
        "settings_asr_aligner_label": "📐 CrispASR強制アライメントモデルを選択。",
        "settings_asr_backend_label": "⚙️ CrispASR認識バックエンドを選択。",
        ...
        "status_no_translator_skip": "[INFO] 翻訳が選択されていません。翻訳ステップをスキップ...",
